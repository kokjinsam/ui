                  ...
                  {(date) => (
                    <CalendarCell
                      ...
                      className={cn(
                        ...
                        "group/calendar-cell selection-start:rounded-s-lg data-outside-month:text-muted-foreground relative size-10 cursor-default [line-height:2.286rem] outline-hidden data-selection-end:rounded-e-lg sm:size-9 sm:text-sm",
